...
func registerQueryRoutes(clientCtx client.Context, r *mux.Router) {
    ...
    r.HandleFunc("/nameservice/names/{id}", getNameHandler(clientCtx)).Methods("GET")
    r.HandleFunc("/nameservice/names", listNameHandler(clientCtx)).Methods("GET")
...
func registerTxHandlers(clientCtx client.Context, r *mux.Router) {
    ...
    r.HandleFunc("/nameservice/names", createNameHandler(clientCtx)).Methods("POST")
    r.HandleFunc("/nameservice/names/{id}", updateNameHandler(clientCtx)).Methods("POST")
    r.HandleFunc("/nameservice/names/{id}", deleteNameHandler(clientCtx)).Methods("POST")
