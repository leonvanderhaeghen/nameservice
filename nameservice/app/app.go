...
import (
	...
	appparams "github.com/leonvanderhaeghen/nameservice/app/params"
	"github.com/leonvanderhaeghen/nameservice/x/nameservice"
	nameservicekeeper "github.com/leonvanderhaeghen/nameservice/x/nameservice/keeper"
	nameservicetypes "github.com/leonvanderhaeghen/nameservice/x/nameservice/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/nameserviced")
	}
...
func New(
	...
	app.nameserviceKeeper = *nameservicekeeper.NewKeeper(
        appCodec, keys[nameservicetypes.StoreKey], keys[nameservicetypes.MemStoreKey],
	)
